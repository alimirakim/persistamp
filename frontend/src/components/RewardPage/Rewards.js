...
export default function Rewards() {
  ...
  if (Object.keys(rewards).length === 0) {
    return (
      <p className="msg-none lo-center">
        You have not added any rewards to the reward shop yet. You can add some 
        by clicking the red trophy icon labeled 'Add' on your ID card. Find it 
        in the top-right corner of your screen. Have fun! :)
      </p>
    )
  }
